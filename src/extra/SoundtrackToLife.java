...
public class SoundtrackToLife {
	...
	public static void main(String[] args) {
		...
		int userMood = JOptionPane.showOptionDialog(null, "How are you feeling today?", "Pop-up Title", 0,
				JOptionPane.INFORMATION_MESSAGE, null, new String[] { "Great", "Fine", "Upset" }, null);
